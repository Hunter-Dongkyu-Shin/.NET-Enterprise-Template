...
namespace templateproject.Infrastructure.Log
{
    ...
    public class when_given_a_log_factory
    {
        ...
        [Ignore("NOTE : Moq에서 Static Mocking에 불가하다.")]
    ...
    [Subject(typeof(Common.Logging.ILog)), Tags("Infrastructure.Log", "Issue"), Ignore(null)] // BUG : MSpec의 Ignore Attribute은 자기 reason까지 무시하나...
    public class when_given_common_logging_logger
    {
        ...
        // BUG : Common.Logging.LogManager.GetCurrentClassLogger가 Client의 Class명을 올바르게 참조하지 못한다.
